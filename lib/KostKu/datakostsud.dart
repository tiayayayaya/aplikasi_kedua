...
class Datakost extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: PropertyOption(title: "2. Alamat Kost"),
            ),
            GestureDetector(
              onTap: () {},
              child: PropertyOption(title: "3. Foto"),
            ),
            GestureDetector(
              onTap: () {},
              child: PropertyOption(title: "4. Fasilitas"),
            ),
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Putihsemua()));
              },
